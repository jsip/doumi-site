    ...
    <footer style={{backgroundColor: '#022B3A'}} className="pb-8">
      <div className="pb-4">
        <div className="lg:flex">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d10866.225975820258!2d-71.2884495302246!3d46.842839899999994!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4cb897ddc2cec043%3A0xd450d4d0da014cc8!2s725%20Bd%20Lebourgneuf%2C%20Qu%C3%A9bec%2C%20QC%20G2J%201S1!5e1!3m2!1sen!2sca!4v1669578617187!5m2!1sen!2sca" width="1920" height="400" style={{border: '0'}} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
        </div>
        <div style={{backgroundColor: '#8693AB'}} className="mb-4">
          <div className="flex gap-x-2 justify-between max-w-2xl m-auto p-6">
            <a href="https://www.ocrcvm.ca/" target="_blank">
              <StaticImage src="https://static.twentyoverten.com/5b6c40e420726c57d29b423f/ymgvsWt1vv/IIROC-fr.png" alt="IIROC logo" className="disclaimer-logo"/>
            </a>
            <a href="https://www.ocrcvm.ca/sections/investisseurs/choisir-un-conseiller-en-placement/rapport-info-conseiller" rel="noopener noreferrer" target="_blank">
              <StaticImage src="https://static.twentyoverten.com/5b6c40e420726c57d29b423f/ErJr6Tzhi9/AdvisorReport-fr.png" alt="Advisor Report logo" className="disclaimer-logo"/>
            </a>
            <a href="https://www.fcpe.ca/" target="_blank">
              <StaticImage src="https://static.twentyoverten.com/5b6c40e420726c57d29b423f/4Qq_YJ8Y16/cipf-fr.png" alt="CIPF logo" className="disclaimer-logo"/>
            </a>
            <a href="https://lautorite.qc.ca/" target="_blank">
              <StaticImage src="https://static.twentyoverten.com/5b6c40e420726c57d29b423f/cG0Z92t2lP/AMF.png" alt="AMF logo" className="disclaimer-logo"/>
            </a>
          </div>
        </div>
        <div className="min-w-screen px-8">
          ...
          <p className="text-center max-w-7xl text-white m-auto">
